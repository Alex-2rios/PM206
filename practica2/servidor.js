...
const productos = [
  { id: 1, nombre: 'Espresso Solo', precio: 45.00, stock: 15 },
  { id: 2, nombre: 'Cafe Americano', precio: 58.00, stock: 20 },
  { id: 3, nombre: 'Capuccino Tradicional', precio: 72.00, stock: 12 },
  { id: 4, nombre: 'Latte Macchiato', precio: 78.00, stock: 10 },
  { id: 5, nombre: 'Caramel Frappuccino', precio: 89.00, stock: 8 },
  { id: 6, nombre: 'Muffin de Chocolate', precio: 45.00, stock: 15 }
];
