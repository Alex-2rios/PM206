...
// SplashScreen se simula con un estado local de carga
// (SplashScreen real solo funciona en App.js, no en screens secundarias)
export default function FondoPantalla() {
  ...
  useEffect(() => {
    async function prepararAplicacion() {
      try {
        // Simulamos una carga de 3 segundos (como haría SplashScreen)
